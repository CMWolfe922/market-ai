...
apikey = 'C1TEUG4JBLJU89X2GDXQ2RHHGUYX0XUZ'
...
class TDA(Params):
    ...
    def quotes(self, stocks):
        ...
        params = {"apikey": TDA.key, "symbol": stocks}
...
class Get(TDA):
    ...
    # ----------------------------------------------------------- #
    # Step 1.1) Check if symbols are in database
    # todo this I am going to create a function that checks for an existing
    # database. if the database exists, it won't run the get.companies function
    # and then the insert function, instead it'll run the query symbols function
    # this function will retrieve the symbols needed and return them in a list object
    # whether the database exists or not.

# =========================================================== #
# [+] READ STOCKDATA NOTES:
# =========================================================== #
# I removed symbols from the Get() class because it needs to use
# a Get() object. Now I need to clean up the symbols function
# and remove a lot of the try: except: statements because they
